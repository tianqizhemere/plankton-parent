...
import top.tianqi.plankton.core.system.mapper.DictionariesMapper;
import top.tianqi.plankton.core.system.service.DictionariesService;
...
public class DictionariesServiceImpl extends BaseServiceImpl<DictionariesMapper, Dictionary> implements DictionariesService {
    ...
    public List<Dictionary> findTree() {
        // 父节点字典列表
        List<Dictionary> parentDictionaries = new ArrayList<>();
        ...
        for (Dictionary dictionary : dictionaries) {
            if (dictionary.getParentId() == null || dictionary.getParentId() == 0) {
                ...
                parentDictionaries.add(dictionary);
            }
        }
        findChildren(parentDictionaries, dictionaries);
