...
CREATE TABLE version (
  ...
  type bigint(20)  DEFAULT NULL COMMENT '是否升级 1升级，0不升级，2强制升级',
  ...
  status bigint(20) DEFAULT NULL COMMENT '0-停用，1-启用',
  PRIMARY KEY (`id`)
...
CREATE TABLE attach (
  ...
  create_time datetime NOT NULL,
  modify_time datetime NOT NULL,
  data_type bigint(20) DEFAULT NULL COMMENT '数据来源',
...
CREATE TABLE user (
  ...
  upload_counter bigint(20) NOT NULL COMMENT '下载次数',
...
CREATE TABLE menu (
  ...
  type bigint(20) DEFAULT NULL COMMENT '类型   0：目录   1：菜单   2：按钮',
...
CREATE TABLE external_app (
  ...
  external_type bigint(20) DEFAULT NULL COMMENT '应用类型',
...
CREATE TABLE notice (
  ...
  read_count bigint(20) DEFAULT NULL COMMENT '已读数量',
  type bigint(20) DEFAULT NULL COMMENT '是否为最新，0-旧通知，1-最新通知',
  PRIMARY KEY (id) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE user_notice (
  ...
  user_id bigint(20) DEFAULT NULL COMMENT '用户id',
  is_read bigint(20) DEFAULT NULL COMMENT '是否读取, 0-未读，1-已读',
  PRIMARY KEY (id) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
