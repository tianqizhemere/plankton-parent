...
CREATE TABLE user (
  ...
  create_time datetime NOT NULL,
  modify_time datetime NOT NULL,
  model varchar(50) NOT NULL COMMIT '手机型号',
  imel varchar(50) NOT NULL COMMIT '会员编号(设备识别码)',
  password varchar(50) NOT NULL COMMIT '密码',
  version_code varchar(50) NOT NULL COMMIT '应用版本',
  upload_counter int(11) NOT NULL COMMIT '下载次数',
  PRIMARY KEY (id) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;