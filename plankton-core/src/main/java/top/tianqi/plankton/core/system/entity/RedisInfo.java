...
public class RedisInfo {
    ...
    static {
        ...
        map.put("used_memory_human", "以可读的格式返回 Redis 分配的内存总量");
        ...
        map.put("used_memory_peak_human", "以可读的格式返回 Redis 的内存消耗峰值");
        ...
        map.put("used_memory_rss_human", "以可读的方式返回 Redis 已分配的内存总量");
        map.put("used_memory_peak_perc", "内存使用率峰值");
        map.put("total_system_memory", "系统总内存");
        map.put("total_system_memory_human", "以可读的方式返回系统总内存");
        map.put("used_memory_lua_human", "以可读的方式返回Lua 引擎所使用的内存大小");
        map.put("maxmemory", "最大内存限制，0表示无限制");
        map.put("maxmemory_human", "以可读的方式返回最大限制内存");
