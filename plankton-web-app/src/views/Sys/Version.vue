    ...
    <el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size"
        ...
        <el-form-item label="升级信息" prop="versionDesc">
          <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="dataForm.versionDesc" auto-complete="off"></el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      onProvincesChange(item){
        ...
        this.dateFormat.modelName = modelName;
      },
      // 获取分页数据
      findPage: function (data) {
        ...
        this.$api.version.findPage({'pageNum': this.pageRequest.pageNum, 'pageSize': this.pageRequest.pageSize, 'name': ''}).then((res) => {
