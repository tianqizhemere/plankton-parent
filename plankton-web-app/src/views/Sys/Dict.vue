  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<kt-button icon="fa fa-search" :label="$t('action.search')" perms="system:dict:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-plus" :label="$t('action.add')" perms="system:dict:save" type="primary" @click="handleAdd" />
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
	<kt-table :height="350" permsEdit="system:dict:update" permsDelete="system:dict:delete"
...
export default {
	...
	methods: {
		...
		findPage: function (data) {
			...
			this.$api.dict.findPage({'pageNum': this.pageRequest.pageNum, 'pageSize': this.pageRequest.pageSize}).then((res) => {
