    ...
    <div class="page-container">
        ...
        <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
            <el-form :inline="true" :model="filters" :size="size">
                ...
                <el-form-item>
                    <kt-button icon="fa fa-search" :label="$t('action.search')" perms="system:dict:view" type="primary"
                               @click="findTreeData(null)"/>
                </el-form-item>
                <el-form-item>
                    <kt-button icon="fa fa-plus" :label="$t('action.add')" perms="system:dict:save" type="primary"
                               @click="handleAdd"/>
                </el-form-item>
            </el-form>
        </div>
        ...
        <el-table :data="tableTreeDdata" stripe size="mini" style="width: 100%;"
            ...
            <el-table-column
                    prop="parentName" header-align="center" align="center" width="120" label="上级节点名称">
            </el-table-column>
            <el-table-column
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <kt-button icon="fa fa-edit" :label="$t('action.edit')" perms="system:dict:update"
                               @click="handleEdit(scope.row)"/>
                    <kt-button icon="fa fa-trash" :label="$t('action.delete')" perms="system:dict:delete" type="danger"
        ...
        <el-button :size="size" type="primary" @click="!dataForm.id ? submitForm('save') : submitForm('edit')">{{$t('action.comfirm')}}</el-button>
      </span>
        </el-dialog>
    </div>
</template>
