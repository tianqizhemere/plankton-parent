<template>
  <div>
    <el-upload action="/api/system/attach/uploadFile" :data="{ dataType: dataType }" :on-success="uploadSuccess" :on-preview="filePreview" :on-remove="fileRemove" :before-remove="beforeRemove" multiple :limit="3" :on-exceed="fileExceed" :file-list="fileList">
